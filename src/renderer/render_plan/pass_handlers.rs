...
impl PassPlanner for ImagePassBlurPlanner {
    fn node_type(&self) -> &'static str {
        "ImagePass"
    }
...
impl PassPlanner for ConvolutionPassPlanner {
    fn node_type(&self) -> &'static str {
        "Convolution"
    }
    ...
    fn plan(
        ...
        pass_assemblers::downsample::assemble_convolution(scene_ref, ctx, layer_id, layer_node)
    }
}
...
impl PassPlanner for MeshGradientPassPlanner {
    fn node_type(&self) -> &'static str {
        "MeshGradient"
    }
    ...
    fn plan(
        ...
        pass_assemblers::mesh_gradient::assemble_mesh_gradient(scene_ref, ctx, layer_id, layer_node)
    }
}
...
impl PassPlannerRegistry {
    pub(crate) fn plan_layer(
        ...
        let Some(planner) = self
            ...
            bail!(
                "Composite layer must be a pass node (RenderPass/ImagePass/GuassianBlurPass/Downsample/Convolution/Upsample/GradientBlur/Composite/BloomNode/IntelligentLight/MeshGradient), got {} for {}. \
