...
{{/if}}
     ...
     var glass_mat = mix(refraction, reflection, clamp(1.0 + dot(normal, incident_ray) * {{uReflectStrength}}, 0.0, 1.0));
    glass_mat = glass_luminance_curve_lab(glass_mat, {{uBlendLuminanceValues}}, {{uBlendLuminanceAmount}});
