...
@group(1) @binding(0)
var img_tex_GroupInstance_52_ImageTexture_PttPromptSend: texture_2d<f32>;

@group(1) @binding(1)
var img_samp_GroupInstance_52_ImageTexture_PttPromptSend: sampler;

@group(1) @binding(2)
var img_tex_GroupInstance_52_ImageTexture_PttPromptCancel: texture_2d<f32>;

@group(1) @binding(3)
var img_samp_GroupInstance_52_ImageTexture_PttPromptCancel: sampler;
...
fn fs_main(in: VSOut) -> @location(0) vec4f {
    // ImageTexture GroupInstance_52/ImageTexture_PttPromptSend aspect-correct uv
    let image_texture_uv = aspect_correct_uv_fill(
        (in.uv),
        vec2f(textureDimensions(img_tex_GroupInstance_52_ImageTexture_PttPromptSend)),
        in.geo_size_px,
    );
    // ImageTexture GroupInstance_52/ImageTexture_PttPromptSend.color
    let image_texture_sample = textureSample(
        img_tex_GroupInstance_52_ImageTexture_PttPromptSend,
        img_samp_GroupInstance_52_ImageTexture_PttPromptSend,
        image_texture_uv,
    );
    // ImageTexture GroupInstance_52/ImageTexture_PttPromptCancel aspect-correct uv
    let image_texture_uv_6abbb65f = aspect_correct_uv_fill(
        (in.uv),
        vec2f(textureDimensions(img_tex_GroupInstance_52_ImageTexture_PttPromptCancel)),
        in.geo_size_px,
    );
    // ImageTexture GroupInstance_52/ImageTexture_PttPromptCancel.color
    let image_texture_sample_bf885b77 = textureSample(
        img_tex_GroupInstance_52_ImageTexture_PttPromptCancel,
        img_samp_GroupInstance_52_ImageTexture_PttPromptCancel,
        image_texture_uv_6abbb65f,
    );
