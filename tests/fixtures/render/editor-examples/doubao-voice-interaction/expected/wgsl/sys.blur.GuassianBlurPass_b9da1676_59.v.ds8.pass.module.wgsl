...
fn fs_main(in: VSOut) -> @location(0) vec4f {
 ...
 let k = array<f32, 8>(0.112693444, 0.135595113, 0.105971016, 0.071936935, 0.042416491, 0.021723535, 0.009663465, 0);
 let o = array<f32, 8>(0.66270721, 2.477807999, 4.460113049, 6.442518234, 8.425065994, 10.407798767, 12.390756607, 0);
 let tap_count: u32 = 7u;
 var color = vec4f(0.0);
