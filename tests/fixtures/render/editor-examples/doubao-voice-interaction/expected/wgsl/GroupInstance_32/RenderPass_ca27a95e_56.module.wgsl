...
fn fs_main(in: VSOut) -> @location(0) vec4f {
    // Shader Material GroupInstance_32/ShaderMaterial_ca27a95e_55.material
    let voice_time_material = shader_material_GroupInstance_32_ShaderMaterial_ca27a95e_55(
        ...
        pass_tex_GroupInstance_32_BloomNode_e44f1972_54,
        pass_samp_GroupInstance_32_BloomNode_e44f1972_54,
        ...
        (shader_material_params.shader_GroupInstance_32_ShaderMaterial_ca27a95e_55_density).x,
        array<f32,
        16>((shader_material_params.shader_GroupInstance_32_ShaderMaterial_ca27a95e_55_human_voice_energies[0]).x, (shader_material_params.shader_GroupInstance_32_ShaderMaterial_ca27a95e_55_human_voice_energies[1]).x, (shader_material_params.shader_GroupInstance_32_ShaderMaterial_ca27a95e_55_human_voice_energies[2]).x, (shader_material_params.shader_GroupInstance_32_ShaderMaterial_ca27a95e_55_human_voice_energies[3]).x, (shader_material_params.shader_GroupInstance_32_ShaderMaterial_ca27a95e_55_human_voice_energies[4]).x, (shader_material_params.shader_GroupInstance_32_ShaderMaterial_ca27a95e_55_human_voice_energies[5]).x, (shader_material_params.shader_GroupInstance_32_ShaderMaterial_ca27a95e_55_human_voice_energies[6]).x, (shader_material_params.shader_GroupInstance_32_ShaderMaterial_ca27a95e_55_human_voice_energies[7]).x, (shader_material_params.shader_GroupInstance_32_ShaderMaterial_ca27a95e_55_human_voice_energies[8]).x, (shader_material_params.shader_GroupInstance_32_ShaderMaterial_ca27a95e_55_human_voice_energies[9]).x, (shader_material_params.shader_GroupInstance_32_ShaderMaterial_ca27a95e_55_human_voice_energies[10]).x, (shader_material_params.shader_GroupInstance_32_ShaderMaterial_ca27a95e_55_human_voice_energies[11]).x, (shader_material_params.shader_GroupInstance_32_ShaderMaterial_ca27a95e_55_human_voice_energies[12]).x, (shader_material_params.shader_GroupInstance_32_ShaderMaterial_ca27a95e_55_human_voice_energies[13]).x, (shader_material_params.shader_GroupInstance_32_ShaderMaterial_ca27a95e_55_human_voice_energies[14]).x, (shader_material_params.shader_GroupInstance_32_ShaderMaterial_ca27a95e_55_human_voice_energies[15]).x),
        ...
        (graph_inputs.node_FloatInput_49_6300f420).x,
        (graph_inputs.node_FloatInput_50_d125f720).x,
