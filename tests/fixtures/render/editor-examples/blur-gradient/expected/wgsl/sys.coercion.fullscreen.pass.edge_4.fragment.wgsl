...
@group(1) @binding(0)
var pass_tex_GradientBlur_5: texture_2d<f32>;

@group(1) @binding(1)
var pass_samp_GradientBlur_5: sampler;
...
fn sample_pass_texture(uv_in: vec2f) -> vec4f {
    return textureSample(pass_tex_GradientBlur_5, pass_samp_GradientBlur_5, uv_in);
}
