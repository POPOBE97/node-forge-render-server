...
@group(1) @binding(0)
var pass_tex_Downsample_e2192d99_24: texture_2d<f32>;

@group(1) @binding(1)
var pass_samp_Downsample_e2192d99_24: sampler;
...
fn sample_pass_texture(uv_in: vec2f) -> vec4f {
    return textureSample(pass_tex_Downsample_e2192d99_24, pass_samp_Downsample_e2192d99_24, uv_in);
}
