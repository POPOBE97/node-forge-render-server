...
struct GraphInputs {
    // Node: rect_pos
    node_rect_pos_22992126: vec4f,
    // Node: rect_size
    node_rect_size_19dd15b9: vec4f,
};
...
@group(1) @binding(0)
var img_tex_img_1: texture_2d<f32>;

@group(1) @binding(1)
var img_samp_img_1: sampler;
 ...
 let rect_size_px_base = (graph_inputs.node_rect_size_19dd15b9).xy;
 let rect_center_px = (graph_inputs.node_rect_pos_22992126).xy;
...
fn fs_main(in: VSOut) -> @location(0) vec4f {
    return textureSample(img_tex_img_1, img_samp_img_1, (in.uv));
}
