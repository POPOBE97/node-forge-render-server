...
@group(1) @binding(0)
var img_tex_ImageTexture_68: texture_2d<f32>;

@group(1) @binding(1)
var img_samp_ImageTexture_68: sampler;
...
fn fs_main(in: VSOut) -> @location(0) vec4f {
    let _frag_out = textureSample(img_tex_ImageTexture_68, img_samp_ImageTexture_68, (in.uv));
