...
fn fs_main(in: VSOut) -> @location(0) vec4f {
    ...
    var mc_GroupInstance_132_GroupInstance_124_MathClosure_102_out: vec4f;
    {
        let c = mc_GroupInstance_132_MathClosure_111_out;
        var output: vec4f;
        output = mc_GroupInstance_132_GroupInstance_124_MathClosure_102_(in.uv, c);
        mc_GroupInstance_132_GroupInstance_124_MathClosure_102_out = output;
    }
    ...
    var mc_GroupInstance_132_GroupInstance_123_MathClosure_122_out: f32;
    {
        let color = mc_GroupInstance_132_MathClosure_94_out;
        var output: f32;
        output = mc_GroupInstance_132_GroupInstance_123_MathClosure_122_(in.uv, color);
        mc_GroupInstance_132_GroupInstance_123_MathClosure_122_out = output;
    }
    var mc_GroupInstance_132_MathClosure_96_out: vec4f;
    {
        ...
        let c_ui = mc_GroupInstance_132_GroupInstance_124_MathClosure_102_out;
        let f = smoothstep(0.0, 0.015, mc_GroupInstance_132_MathClosure_91_out);
        let l = mc_GroupInstance_132_MathClosure_104_out;
        let selection = mc_GroupInstance_132_MathClosure_115_out;
        let lumin_edge = mc_GroupInstance_132_GroupInstance_123_MathClosure_122_out;
        var output: vec4f;
        output = mc_GroupInstance_132_MathClosure_96_(in.uv, c_edge, e, c_ui, f, l, selection, lumin_edge);
