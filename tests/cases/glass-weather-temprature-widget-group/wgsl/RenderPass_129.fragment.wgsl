...
fn mc_GroupInstance_132_MathClosure_102_(uv: vec2<f32>, c: vec4<f32>) -> vec4<f32> {
    var uv_1: vec2<f32>;
    var c_1: vec4<f32>;
...
fn mc_GroupInstance_132_MathClosure_103_(uv: vec2<f32>, c: vec4<f32>) -> vec4<f32> {
    var uv_1: vec2<f32>;
    var c_1: vec4<f32>;
    var output: vec4<f32> = vec4(0f);
...
fn mc_GroupInstance_132_MathClosure_111_(uv: vec2<f32>, t: f32, c: vec4<f32>, thumb: f32) -> vec4<f32> {
    var uv_1: vec2<f32>;
    var t_1: f32;
    var c_1: vec4<f32>;
    var thumb_1: f32;
...
fn mc_GroupInstance_132_MathClosure_115_(uv: vec2<f32>, sdf: f32) -> f32 {
    var uv_1: vec2<f32>;
    var sdf_1: f32;
    var output: f32 = 0f;
    var r: f32;
...
fn mc_GroupInstance_132_MathClosure_94_(uv: vec2<f32>, c_edge: vec4<f32>) -> vec4<f32> {
    var uv_1: vec2<f32>;
...
fn mc_GroupInstance_132_MathClosure_96_(uv: vec2<f32>, c_edge: vec4<f32>, e: f32, c_ui: vec4<f32>, f: f32, l: f32, selection: f32) -> vec4<f32> {
    var uv_1: vec2<f32>;
    var c_edge_1: vec4<f32>;
    var e_1: f32;
    var c_ui_1: vec4<f32>;
...
fn mc_GroupInstance_132_MathClosure_99_(uv: vec2<f32>, xy: vec2<f32>, size: vec2<f32>) -> vec2<f32> {
    var uv_1: vec2<f32>;
    var xy_1: vec2<f32>;
    var size_1: vec2<f32>;
    var output: vec2<f32> = vec2(0f);
...
fn fs_main(in: VSOut) -> @location(0) vec4f {
        var mc_GroupInstance_132_MathClosure_79_out: vec2f;
    {
        ...
        var output: vec2f;
        output = mc_GroupInstance_132_MathClosure_79_(in.uv, n, i, xy, size, ior, depth);
    ...
    var mc_GroupInstance_132_MathClosure_102_out: vec4f;
    {
        let c = textureSample(pass_tex_GroupInstance_132_GuassianBlurPass_85, pass_samp_GroupInstance_132_GuassianBlurPass_85, vec2f((mc_GroupInstance_132_MathClosure_88_out).x, 1.0 - (mc_GroupInstance_132_MathClosure_88_out).y));
        var output: vec4f;
        output = mc_GroupInstance_132_MathClosure_102_(in.uv, c);
        mc_GroupInstance_132_MathClosure_102_out = output;
    }
    ...
    var mc_GroupInstance_132_MathClosure_87_out: vec4f;
    {
        let c = mc_GroupInstance_132_MathClosure_102_out;
        let f = smoothstep(0.0, 0.015, mc_GroupInstance_132_MathClosure_91_out);
        var output: vec4f;
        output = mc_GroupInstance_132_MathClosure_87_(in.uv, c, f);
        mc_GroupInstance_132_MathClosure_87_out = output;
    }
    var mc_GroupInstance_132_MathClosure_94_out: vec4f;
    {
        let c_edge = mc_GroupInstance_132_MathClosure_87_out;
        var output: vec4f;
        output = mc_GroupInstance_132_MathClosure_94_(in.uv, c_edge);
        mc_GroupInstance_132_MathClosure_94_out = output;
    }
    ...
    var mc_GroupInstance_132_MathClosure_99_out: vec2f;
    {
        let xy = in.local_px;
        let size = in.geo_size_px;
        var output: vec2f;
        output = mc_GroupInstance_132_MathClosure_99_(in.uv, xy, size);
        mc_GroupInstance_132_MathClosure_99_out = output;
    }
    var mc_GroupInstance_132_MathClosure_111_out: vec4f;
    {
        ...
        let c = textureSample(img_tex_GroupInstance_132_ImageTexture_76, img_samp_GroupInstance_132_ImageTexture_76, (mc_GroupInstance_132_MathClosure_99_out));
        let thumb = smoothstep(-7.0, -8.0, (length((in.local_px - mc_GroupInstance_132_MathClosure_108_out)) - 16.5));
        var output: vec4f;
        output = mc_GroupInstance_132_MathClosure_111_(in.uv, t, c, thumb);
        mc_GroupInstance_132_MathClosure_111_out = output;
    }
    var mc_GroupInstance_132_MathClosure_103_out: vec4f;
    {
        let c = mc_GroupInstance_132_MathClosure_111_out;
        var output: vec4f;
        output = mc_GroupInstance_132_MathClosure_103_(in.uv, c);
        mc_GroupInstance_132_MathClosure_103_out = output;
    }
