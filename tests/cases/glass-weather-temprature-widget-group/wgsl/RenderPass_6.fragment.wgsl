...
fn fs_main(in: VSOut) -> @location(0) vec4f {
    ...
    var mc_GroupInstance_128_MathClosure_111_out: vec4f;
    {
        ...
        let c_ui = nf_premultiply(textureSample(img_tex_GroupInstance_128_ImageTexture_76, img_samp_GroupInstance_128_ImageTexture_76, (mc_GroupInstance_128_GroupInstance_125_MathClosure_99_out)));
