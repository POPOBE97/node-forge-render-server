...
fn mc_GroupInstance_128_GroupInstance_125_MathClosure_99_(uv: vec2<f32>, xy: vec2<f32>, size: vec2<f32>) -> vec2<f32> {
    var uv_1: vec2<f32>;
    var xy_1: vec2<f32>;
    var size_1: vec2<f32>;
...
fn fs_main(in: VSOut) -> @location(0) vec4f {
    ...
    var mc_GroupInstance_128_GroupInstance_125_MathClosure_99_out: vec2f;
    {
        let xy = in.local_px;
        let size = in.geo_size_px;
        var output: vec2f;
        output = mc_GroupInstance_128_GroupInstance_125_MathClosure_99_(in.uv, xy, size);
        mc_GroupInstance_128_GroupInstance_125_MathClosure_99_out = output;
    }
    var mc_GroupInstance_128_MathClosure_111_out: vec4f;
    {
        ...
        let c = textureSample(img_tex_GroupInstance_128_ImageTexture_76, img_samp_GroupInstance_128_ImageTexture_76, (mc_GroupInstance_128_GroupInstance_125_MathClosure_99_out));
    ...
    {
        let color = mc_GroupInstance_128_MathClosure_87_out;
        var output: f32;
