...
fn fs_main(in: VSOut) -> @location(0) vec4f {
        var mc_GroupInstance_135_MathClosure_79_out: vec2f;
    {
        ...
        let depth = sdf2d_bevel_smooth5(sdf2d_round_rect((in.local_px - (in.geo_size_px * vec2f((graph_inputs.node_GroupInstance_135_FloatInput_10_2a8c3aed).x))), (in.geo_size_px * 0.5), vec4f((graph_inputs.node_GroupInstance_135_FloatInput_12_c4883aed).x)), 24, 0.03);
        let refract_offset = refract(normalize((graph_inputs.node_GroupInstance_135_Vector3Input_80_cd4f4a91).xyz), normalize(normalize(vec3f(-(((sdf2d_bevel_smooth5(sdf2d_round_rect(((in.local_px + vec2f(1.0, 0.0)) - (in.geo_size_px * vec2f((graph_inputs.node_GroupInstance_135_FloatInput_10_2a8c3aed).x))), (in.geo_size_px * 0.5), vec4f((graph_inputs.node_GroupInstance_135_FloatInput_12_c4883aed).x)), 24, 0.03)) - (sdf2d_bevel_smooth5(sdf2d_round_rect(((in.local_px + vec2f(-1.0, 0.0)) - (in.geo_size_px * vec2f((graph_inputs.node_GroupInstance_135_FloatInput_10_2a8c3aed).x))), (in.geo_size_px * 0.5), vec4f((graph_inputs.node_GroupInstance_135_FloatInput_12_c4883aed).x)), 24, 0.03))) * 0.5), -(((sdf2d_bevel_smooth5(sdf2d_round_rect(((in.local_px + vec2f(0.0, 1.0)) - (in.geo_size_px * vec2f((graph_inputs.node_GroupInstance_135_FloatInput_10_2a8c3aed).x))), (in.geo_size_px * 0.5), vec4f((graph_inputs.node_GroupInstance_135_FloatInput_12_c4883aed).x)), 24, 0.03)) - (sdf2d_bevel_smooth5(sdf2d_round_rect(((in.local_px + vec2f(0.0, -1.0)) - (in.geo_size_px * vec2f((graph_inputs.node_GroupInstance_135_FloatInput_10_2a8c3aed).x))), (in.geo_size_px * 0.5), vec4f((graph_inputs.node_GroupInstance_135_FloatInput_12_c4883aed).x)), 24, 0.03))) * 0.5), 1.0))), (1.0 / (1.450000048)));
        var output: vec2f;
    ...
    {
        let n = normalize(vec3f(-(((sdf2d_bevel_smooth5(sdf2d_round_rect(((in.local_px + vec2f(1.0, 0.0)) - (in.geo_size_px * vec2f((graph_inputs.node_GroupInstance_135_FloatInput_10_2a8c3aed).x))), (in.geo_size_px * 0.5), vec4f((graph_inputs.node_GroupInstance_135_FloatInput_12_c4883aed).x)), 24, 0.03)) - (sdf2d_bevel_smooth5(sdf2d_round_rect(((in.local_px + vec2f(-1.0, 0.0)) - (in.geo_size_px * vec2f((graph_inputs.node_GroupInstance_135_FloatInput_10_2a8c3aed).x))), (in.geo_size_px * 0.5), vec4f((graph_inputs.node_GroupInstance_135_FloatInput_12_c4883aed).x)), 24, 0.03))) * 0.5), -(((sdf2d_bevel_smooth5(sdf2d_round_rect(((in.local_px + vec2f(0.0, 1.0)) - (in.geo_size_px * vec2f((graph_inputs.node_GroupInstance_135_FloatInput_10_2a8c3aed).x))), (in.geo_size_px * 0.5), vec4f((graph_inputs.node_GroupInstance_135_FloatInput_12_c4883aed).x)), 24, 0.03)) - (sdf2d_bevel_smooth5(sdf2d_round_rect(((in.local_px + vec2f(0.0, -1.0)) - (in.geo_size_px * vec2f((graph_inputs.node_GroupInstance_135_FloatInput_10_2a8c3aed).x))), (in.geo_size_px * 0.5), vec4f((graph_inputs.node_GroupInstance_135_FloatInput_12_c4883aed).x)), 24, 0.03))) * 0.5), 1.0));
        var output: f32;
    ...
    {
        let c_edge = textureSample(pass_tex_GroupInstance_135_GuassianBlurPass_85, pass_samp_GroupInstance_135_GuassianBlurPass_85, nf_uv_pass(mc_GroupInstance_135_MathClosure_88_out));
        ...
        let lumin_edge = clamp(dot((textureSample(pass_tex_GroupInstance_135_GuassianBlurPass_85, pass_samp_GroupInstance_135_GuassianBlurPass_85, nf_uv_pass(mc_GroupInstance_135_MathClosure_88_out))).rgb, vec3f(0.2126, 0.7152, 0.0722)), 0.0, 1.0);
        var output: vec4f;
