...
fn mc_GroupInstance_135_MathClosure_102_(uv: vec2<f32>, c: vec4<f32>) -> vec4<f32> {
    var uv_1: vec2<f32>;
    var c_1: vec4<f32>;
...
fn mc_GroupInstance_135_MathClosure_103_(uv: vec2<f32>, c: vec4<f32>) -> vec4<f32> {
    var uv_1: vec2<f32>;
    var c_1: vec4<f32>;
    var output: vec4<f32> = vec4(0f);
...
fn mc_GroupInstance_135_MathClosure_111_(uv: vec2<f32>, t: f32, c: vec4<f32>, thumb: f32) -> vec4<f32> {
    var uv_1: vec2<f32>;
    var t_1: f32;
    var c_1: vec4<f32>;
    var thumb_1: f32;
...
fn mc_GroupInstance_135_MathClosure_96_(uv: vec2<f32>, c_edge: vec4<f32>, e: f32, c_ui: vec4<f32>, f: f32, l: f32, selection: f32) -> vec4<f32> {
    var uv_1: vec2<f32>;
    var c_edge_1: vec4<f32>;
    var e_1: f32;
    var c_ui_1: vec4<f32>;
...
fn fs_main(in: VSOut) -> @location(0) vec4f {
        var mc_GroupInstance_135_MathClosure_79_out: vec2f;
    {
        ...
        var output: vec2f;
        output = mc_GroupInstance_135_MathClosure_79_(in.uv, n, i, xy, size, ior, depth);
    ...
    var mc_GroupInstance_135_MathClosure_102_out: vec4f;
    {
        let c = textureSample(pass_tex_GroupInstance_135_GuassianBlurPass_85, pass_samp_GroupInstance_135_GuassianBlurPass_85, vec2f((mc_GroupInstance_135_MathClosure_88_out).x, 1.0 - (mc_GroupInstance_135_MathClosure_88_out).y));
        var output: vec4f;
        output = mc_GroupInstance_135_MathClosure_102_(in.uv, c);
        mc_GroupInstance_135_MathClosure_102_out = output;
    }
    ...
    var mc_GroupInstance_135_MathClosure_87_out: vec4f;
    {
        let c = mc_GroupInstance_135_MathClosure_102_out;
    ...
    var mc_GroupInstance_135_MathClosure_111_out: vec4f;
    {
        ...
        var output: vec4f;
        output = mc_GroupInstance_135_MathClosure_111_(in.uv, t, c, thumb);
        mc_GroupInstance_135_MathClosure_111_out = output;
    }
    var mc_GroupInstance_135_MathClosure_103_out: vec4f;
    {
        let c = mc_GroupInstance_135_MathClosure_111_out;
        var output: vec4f;
        output = mc_GroupInstance_135_MathClosure_103_(in.uv, c);
        mc_GroupInstance_135_MathClosure_103_out = output;
    }
    ...
    var mc_GroupInstance_135_MathClosure_96_out: vec4f;
    {
        ...
        let c_ui = mc_GroupInstance_135_MathClosure_103_out;
        let f = smoothstep(0.0, 0.015, mc_GroupInstance_135_MathClosure_91_out);
        let l = mc_GroupInstance_135_MathClosure_104_out;
        let selection = mc_GroupInstance_135_MathClosure_115_out;
        var output: vec4f;
        output = mc_GroupInstance_135_MathClosure_96_(in.uv, c_edge, e, c_ui, f, l, selection);
        mc_GroupInstance_135_MathClosure_96_out = output;
    }
    return mc_GroupInstance_135_MathClosure_96_out;
}
