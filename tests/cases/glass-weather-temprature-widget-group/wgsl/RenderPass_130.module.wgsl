...
fn mc_GroupInstance_135_MathClosure_111_(uv: vec2<f32>, t: f32, c: vec4<f32>, thumb: f32, show_thumb: f32) -> vec4<f32> {
    var uv_1: vec2<f32>;
    var t_1: f32;
    var c_1: vec4<f32>;
    var thumb_1: f32;
...
fn fs_main(in: VSOut) -> @location(0) vec4f {
    ...
    var mc_GroupInstance_135_MathClosure_111_out: vec4f;
    {
        ...
        var output: vec4f;
        output = mc_GroupInstance_135_MathClosure_111_(in.uv, t, c, thumb, select(0.0, 1.0, show_thumb));
        mc_GroupInstance_135_MathClosure_111_out = output;
    }
    var mc_GroupInstance_135_GroupInstance_124_MathClosure_102_out: vec4f;
    {
        let c = mc_GroupInstance_135_MathClosure_111_out;
        var output: vec4f;
        output = mc_GroupInstance_135_GroupInstance_124_MathClosure_102_(in.uv, c);
        mc_GroupInstance_135_GroupInstance_124_MathClosure_102_out = output;
    }
    ...
    var mc_GroupInstance_135_MathClosure_96_out: vec4f;
    {
        ...
        let lumin_edge = mc_GroupInstance_135_GroupInstance_123_MathClosure_122_out;
        var output: vec4f;
        output = mc_GroupInstance_135_MathClosure_96_(in.uv, c_edge, e, c_ui, f, l, selection, lumin_edge);
