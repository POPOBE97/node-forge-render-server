...
@group(1) @binding(0)
var img_tex_GroupInstance_135_ImageTexture_76: texture_2d<f32>;
...
fn fs_main(in: VSOut) -> @location(0) vec4f {
        var mc_GroupInstance_135_MathClosure_79_out: vec2f;
    {
        let xy = in.local_px.xy;
        let size = in.geo_size_px;
        let depth = sdf2d_bevel_smooth5(sdf2d_round_rect((in.local_px.xy - (in.geo_size_px * vec2f((graph_inputs.node_GroupInstance_135_FloatInput_10_2a8c3aed).x))), (in.geo_size_px * 0.5), vec4f((graph_inputs.node_GroupInstance_135_FloatInput_12_c4883aed).x)), 24, 0.03);
        let refract_offset = refract(normalize((graph_inputs.node_GroupInstance_135_Vector3Input_80_cd4f4a91).xyz), normalize(normalize(vec3f(-(((sdf2d_bevel_smooth5(sdf2d_round_rect(((in.local_px.xy + vec2f(1.0, 0.0)) - (in.geo_size_px * vec2f((graph_inputs.node_GroupInstance_135_FloatInput_10_2a8c3aed).x))), (in.geo_size_px * 0.5), vec4f((graph_inputs.node_GroupInstance_135_FloatInput_12_c4883aed).x)), 24, 0.03)) - (sdf2d_bevel_smooth5(sdf2d_round_rect(((in.local_px.xy + vec2f(-1.0, 0.0)) - (in.geo_size_px * vec2f((graph_inputs.node_GroupInstance_135_FloatInput_10_2a8c3aed).x))), (in.geo_size_px * 0.5), vec4f((graph_inputs.node_GroupInstance_135_FloatInput_12_c4883aed).x)), 24, 0.03))) * 0.5), -(((sdf2d_bevel_smooth5(sdf2d_round_rect(((in.local_px.xy + vec2f(0.0, 1.0)) - (in.geo_size_px * vec2f((graph_inputs.node_GroupInstance_135_FloatInput_10_2a8c3aed).x))), (in.geo_size_px * 0.5), vec4f((graph_inputs.node_GroupInstance_135_FloatInput_12_c4883aed).x)), 24, 0.03)) - (sdf2d_bevel_smooth5(sdf2d_round_rect(((in.local_px.xy + vec2f(0.0, -1.0)) - (in.geo_size_px * vec2f((graph_inputs.node_GroupInstance_135_FloatInput_10_2a8c3aed).x))), (in.geo_size_px * 0.5), vec4f((graph_inputs.node_GroupInstance_135_FloatInput_12_c4883aed).x)), 24, 0.03))) * 0.5), 1.0))), (1.0 / (1.450000048)));
        var output: vec2f;
        output = mc_GroupInstance_135_MathClosure_79_(in.uv, xy, size, depth, refract_offset);
        mc_GroupInstance_135_MathClosure_79_out = output;
    }
    var mc_GroupInstance_135_MathClosure_88_out: vec2f;
    {
        let uv = mc_GroupInstance_135_MathClosure_79_out;
        let scale = (graph_inputs.node_GroupInstance_135_FloatInput_89_00da25ed).x;
        var output: vec2f;
        output = mc_GroupInstance_135_MathClosure_88_(in.uv, uv, scale);
        mc_GroupInstance_135_MathClosure_88_out = output;
    }
    var mc_GroupInstance_135_MathClosure_63_out: f32;
    {
        let n = normalize(vec3f(-(((sdf2d_bevel_smooth5(sdf2d_round_rect(((in.local_px.xy + vec2f(1.0, 0.0)) - (in.geo_size_px * vec2f((graph_inputs.node_GroupInstance_135_FloatInput_10_2a8c3aed).x))), (in.geo_size_px * 0.5), vec4f((graph_inputs.node_GroupInstance_135_FloatInput_12_c4883aed).x)), 24, 0.03)) - (sdf2d_bevel_smooth5(sdf2d_round_rect(((in.local_px.xy + vec2f(-1.0, 0.0)) - (in.geo_size_px * vec2f((graph_inputs.node_GroupInstance_135_FloatInput_10_2a8c3aed).x))), (in.geo_size_px * 0.5), vec4f((graph_inputs.node_GroupInstance_135_FloatInput_12_c4883aed).x)), 24, 0.03))) * 0.5), -(((sdf2d_bevel_smooth5(sdf2d_round_rect(((in.local_px.xy + vec2f(0.0, 1.0)) - (in.geo_size_px * vec2f((graph_inputs.node_GroupInstance_135_FloatInput_10_2a8c3aed).x))), (in.geo_size_px * 0.5), vec4f((graph_inputs.node_GroupInstance_135_FloatInput_12_c4883aed).x)), 24, 0.03)) - (sdf2d_bevel_smooth5(sdf2d_round_rect(((in.local_px.xy + vec2f(0.0, -1.0)) - (in.geo_size_px * vec2f((graph_inputs.node_GroupInstance_135_FloatInput_10_2a8c3aed).x))), (in.geo_size_px * 0.5), vec4f((graph_inputs.node_GroupInstance_135_FloatInput_12_c4883aed).x)), 24, 0.03))) * 0.5), 1.0));
        var output: f32;
        output = mc_GroupInstance_135_MathClosure_63_(in.uv, n);
        mc_GroupInstance_135_MathClosure_63_out = output;
    }
    var mc_GroupInstance_135_MathClosure_91_out: f32;
    {
        let x = mc_GroupInstance_135_MathClosure_63_out;
        var output: f32;
        output = mc_GroupInstance_135_MathClosure_91_(in.uv, x);
        mc_GroupInstance_135_MathClosure_91_out = output;
    }
    var mc_GroupInstance_135_MathClosure_104_out: f32;
    {
        let n = normalize(vec3f(-(((sdf2d_bevel_smooth5(sdf2d_round_rect(((in.local_px.xy + vec2f(1.0, 0.0)) - (in.geo_size_px * vec2f((graph_inputs.node_GroupInstance_135_FloatInput_10_2a8c3aed).x))), (in.geo_size_px * 0.5), vec4f((graph_inputs.node_GroupInstance_135_FloatInput_12_c4883aed).x)), 24, 0.03)) - (sdf2d_bevel_smooth5(sdf2d_round_rect(((in.local_px.xy + vec2f(-1.0, 0.0)) - (in.geo_size_px * vec2f((graph_inputs.node_GroupInstance_135_FloatInput_10_2a8c3aed).x))), (in.geo_size_px * 0.5), vec4f((graph_inputs.node_GroupInstance_135_FloatInput_12_c4883aed).x)), 24, 0.03))) * 0.5), -(((sdf2d_bevel_smooth5(sdf2d_round_rect(((in.local_px.xy + vec2f(0.0, 1.0)) - (in.geo_size_px * vec2f((graph_inputs.node_GroupInstance_135_FloatInput_10_2a8c3aed).x))), (in.geo_size_px * 0.5), vec4f((graph_inputs.node_GroupInstance_135_FloatInput_12_c4883aed).x)), 24, 0.03)) - (sdf2d_bevel_smooth5(sdf2d_round_rect(((in.local_px.xy + vec2f(0.0, -1.0)) - (in.geo_size_px * vec2f((graph_inputs.node_GroupInstance_135_FloatInput_10_2a8c3aed).x))), (in.geo_size_px * 0.5), vec4f((graph_inputs.node_GroupInstance_135_FloatInput_12_c4883aed).x)), 24, 0.03))) * 0.5), 1.0));
        let i = (graph_inputs.node_GroupInstance_135_Vector3Input_105_1bad8802).xyz;
        var output: f32;
        output = mc_GroupInstance_135_MathClosure_104_(in.uv, n, i);
        mc_GroupInstance_135_MathClosure_104_out = output;
    }
    var mc_GroupInstance_135_MathClosure_108_out: vec2f;
    {
        let t = (graph_inputs.node_FloatInput_138_0ccf2f17).x;
        let size = in.geo_size_px;
        var output: vec2f;
    ...
    {
        let sdf = (length((in.local_px.xy - mc_GroupInstance_135_MathClosure_108_out)) - 16.5);
    ...
    var mc_GroupInstance_135_MathClosure_96_out: vec4f;
    {
        ...
        let e = smoothstep(0.0, -2.0, sdf2d_round_rect((in.local_px.xy - (in.geo_size_px * vec2f((graph_inputs.node_GroupInstance_135_FloatInput_10_2a8c3aed).x))), (in.geo_size_px * 0.5), vec4f((graph_inputs.node_GroupInstance_135_FloatInput_12_c4883aed).x)));
    ...
    {
        let t = smoothstep(0.0, 1.0, (length((in.local_px.xy - mc_GroupInstance_135_MathClosure_108_out)) - 16.5));
        let c_ui = textureSample(img_tex_GroupInstance_135_ImageTexture_76, img_samp_GroupInstance_135_ImageTexture_76, aspect_correct_uv_fill((in.uv), vec2f(textureDimensions(img_tex_GroupInstance_135_ImageTexture_76)), in.geo_size_px));
        let thumb = smoothstep(-7.0, -8.0, (length((in.local_px.xy - mc_GroupInstance_135_MathClosure_108_out)) - 16.5));
        let show_thumb = ((graph_inputs.node_BoolInput_141_609f47c1).x != 0);
        var output: vec4f;
