...
struct GraphInputs {
    // Node: Vector2Input_87
    node_Vector2Input_87_b4e653bd: vec4f,
    // Node: Vector2Input_88
    node_Vector2Input_88_69d753bd: vec4f,
};
...
fn mc_GroupInstance_72_MathClosure_30_(uv: vec2<f32>, xy: vec2<f32>, size: vec2<f32>) -> vec2<f32> {
    var uv_1: vec2<f32>;
    var xy_1: vec2<f32>;
    var size_1: vec2<f32>;
 ...
 let rect_size_px_base = (graph_inputs.node_Vector2Input_87_b4e653bd).xy;
 let rect_center_px = (graph_inputs.node_Vector2Input_88_69d753bd).xy;
...
fn fs_main(in: VSOut) -> @location(0) vec4f {
        var mc_GroupInstance_72_MathClosure_30_out: vec2f;
    {
        let xy = in.local_px;
