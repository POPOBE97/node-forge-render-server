...
fn mc_GroupInstance_35_MathClosure_30_(uv: vec2<f32>, xy: vec2<f32>, size: vec2<f32>) -> vec2<f32> {
    var uv_1: vec2<f32>;
    var xy_1: vec2<f32>;
    var size_1: vec2<f32>;
...
fn fs_main(in: VSOut) -> @location(0) vec4f {
        var mc_GroupInstance_35_MathClosure_30_out: vec2f;
    {
    ...
    let _frag_out = textureSample(pass_tex_Downsample_12, pass_samp_Downsample_12, vec2f((mc_GroupInstance_35_MathClosure_30_out).x, 1.0 - (mc_GroupInstance_35_MathClosure_30_out).y));
