...
fn fs_main(in: VSOut) -> @location(0) vec4f {
    ...
    let _frag_out = textureSample(pass_tex_Downsample_18, pass_samp_Downsample_18, vec2f((mc_GroupInstance_64_MathClosure_30_out).x, 1.0 - (mc_GroupInstance_64_MathClosure_30_out).y));
