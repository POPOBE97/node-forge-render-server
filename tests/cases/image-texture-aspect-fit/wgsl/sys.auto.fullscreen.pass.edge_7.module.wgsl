...
fn fs_main(in: VSOut) -> @location(0) vec4f {
    let _frag_out = textureSample(img_tex_ImageTexture_9, img_samp_ImageTexture_9, aspect_correct_uv_fit((in.uv), vec2f(textureDimensions(img_tex_ImageTexture_9)), in.geo_size_px));
